...
export const teamMembers = [
    {
        ...
        imageUrl: 'https://storage.googleapis.com/project-spark-b2481-avatars/a08404a1-871d-400a-97d5-d86f91f7401c.png',
    ...
    },
    {
        ...
        bio: "Joe Handy is a nationally recognized executive with over 25 years of leadership experience in fundraising, operations, and organizational transformation across hospitality, nonprofit, and cultural institutions. He leads RTG’s investor relations, capital development, and partnership strategy.\n\nPreviously, Joe served as President & CEO of the Clearwater Marine Aquarium, where he led a multi-year growth and debt-restructuring initiative that expanded facilities and diversified revenue. As President & COO of the Georgia Aquarium, he oversaw one of the world’s most-visited aquariums, achieving record attendance, launching The Aquarium TV series on Animal Planet, and earning national recognition for operational innovation.\n\nEducation: Executive MBA, Kennesaw State University; B.A., Political Science, College of New Rochelle\nAffiliations: Board Member, Georgia Chamber of Commerce and Metro Atlanta Chamber; Atlanta Business League Men of Influence Award recipient; Leadership Atlanta Class of 2019.",
    ...
    },
    {
        ...
        imageUrl: 'https://images.unsplash.com/photo-1566753323558-f4e0952af115?q=80&w=1921&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
        imageHint: 'man professional'
    },
    {
        id: 'team-member-7',
    ...
    },
    {
        ...
        imageUrl: 'https://images.unsplash.com/photo-1521119989659-a83eee488004?q=80&w=1974&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
        imageHint: 'man professional'
    }
];
